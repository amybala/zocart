				...
				{if $use_taxes}
					{if $priceDisplay}
						<tr class="cart_total_price">
                            ...
                            <td rowspan="{2+$total_discounts_num+$use_show_taxes+$total_wrapping_taxes_num}" colspan="3" id="cart_voucher" class="cart_voucher">
								{if $voucherAllowed}
					...
					{else}
						<tr class="cart_total_price">
                            ...
                            <td rowspan="{2+$total_discounts_num+$use_show_taxes+$total_wrapping_taxes_num}" colspan="2" id="cart_voucher" class="cart_voucher">
								{if $voucherAllowed}
									{if isset($errors_discount) && $errors_discount}
										<ul class="alert alert-danger">
											{foreach $errors_discount as $k=>$error}
