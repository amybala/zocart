...
class FlexibleCustom extends Module
{
    ...
    public function hooks($hookName, $param){		
        ...
        return $this->display(__FILE__, 'flexiblecustom.tpl', $this->getCacheId());        
    }
