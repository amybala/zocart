...
*/
//require (dirname(__FILE__).'/FlexibleBrandFunctions.php');
//require (dirname(__FILE__).'/FlexibleBrandFastCache.php');
//FlexibleBrandFastCache::$storage = "auto";
//FlexibleBrandFastCache::$path = dirname(__FILE__).'/cache/';
//FlexibleBrandFastCache::$securityKey = "flexible-brand.cache";
//FlexibleBrandFastCache::cleanup();
class FlexibleBrands extends Module
{
	...
	*/ 
    ...
    public function hooks($hookName, $param){
        ...
        return $this->display(__FILE__, 'flexiblebrand.tpl', $this->getCacheId());          
    }
    public function buildModule($module){
		...
		return $this->display(__FILE__, $moduleParams->moduleLayout.'.layout.tpl', $this->getCacheId('groups|'.$module['id']));		
    }
