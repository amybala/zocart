	...
	*/
    ...
    public function hooks($hookName, $param){    	
        ...
        if($items){
            ...
            return $this->display(__FILE__, $moduleLayout, $this->getCacheId());
        }        
    }    
	...
	{		
		Tools::clearCache(Context::getContext()->smarty, $this->getTemplatePath('oviccustomtags.tpl'));		
		//parent::_clearCache('oviccustomtags.tpl');
		//parent::_clearCache('oviccustomtags.tpl', 'oviccustomtags|'.$name);
		//$this->_clearCache('oviccustomtags.tpl');
	}
