...
class CategorySearchCateSearchModuleFrontController extends ModuleFrontController
	...
	{ 
		...
		if (Tools::getValue('instantSearch') && !is_array($query))
		{
			...
			$this->context->smarty->assign(array(
				'products' => $results, // DEPRECATED (since to 1.4), not use this: conflict with block_cart module
				'search_products' => $search['result'],
				'nbProducts' => $search['total'],
				'search_query' => $original_query,
				'instant_search' => $this->instant_search,
                'request'=>$this->context->link->getModuleLink('categorysearch', 'catesearch'),
