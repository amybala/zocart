...
class BrandsSlider extends Module
{
    public function __construct()
    {
		...
		$this->displayName = $this->l('Supershop - Brands slider block');
        $this->description = $this->l('Displays a block listing product manufacturers and/or brands.');
    }

	public function install()
	{
		return parent::install() && $this->registerHook('displayGroupSports');
    }
	...
	{
		return $this->hookdisplayGroupSports($params);
	}
