...
class OvicCustomBanner extends Module
{
	...
	*/
    ...
    public function hooks($hookName, $param){   
        ...
        if (!$this->isCached('oviccustombanner.tpl', $this->getCacheId($hookId)))
		{			
		...
		return $this->display(__FILE__, $moduleLayout, $this->getCacheId($hookId));		
    }    
	...
	{		
		parent::_clearCache('oviccustombanner.tpl');
		//$this->_clearCache('oviccustombanner.tpl');
	}
