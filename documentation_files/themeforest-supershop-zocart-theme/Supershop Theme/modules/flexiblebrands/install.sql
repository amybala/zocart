DROP TABLE IF EXISTS `PREFIX_flexiblebrand_group_lang`;
CREATE TABLE `PREFIX_flexiblebrand_group_lang` (
...
DROP TABLE IF EXISTS `PREFIX_flexiblebrand_group_products`;
CREATE TABLE `PREFIX_flexiblebrand_group_products` (
...
DROP TABLE IF EXISTS `PREFIX_flexiblebrand_groups`;
CREATE TABLE `PREFIX_flexiblebrand_groups` (
...
DROP TABLE IF EXISTS `PREFIX_flexiblebrand_module_lang`;
CREATE TABLE `PREFIX_flexiblebrand_module_lang` (
  `module_id` int(10) unsigned NOT NULL,
  `id_lang` int(10) unsigned NOT NULL,
  `id_shop` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_flexiblebrand_modules`;
CREATE TABLE `PREFIX_flexiblebrand_modules` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_shop` int(10) unsigned NOT NULL,
